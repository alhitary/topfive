...
$lang = array_merge($lang, array(
	...
	'TF_EXCLUDED'	=> 'استثناء المنتديات ',
	'TF_EXCLUDED_EXPLAIN'	=> 'اكتب أرقام المنتديات التي تريد عدم عرضها في القائمة , أعمل علامة الفاصلة بين كل رقم ( مثال : 7,9 )<br>أعمل القيمة صفر لو تريد ظهور جميع المنتديات في القائمة.',
